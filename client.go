...
//func (s *server) Key(se, k string) (res *ConfigSectionResponse, err error) {
//	err = s.requester(http.MethodGet, fmt.Sprintf("/_config/%s/%s", se, k), nil, res)
// TODO
//	return
//}
//
//func (s *server) SetKey(se, k string) (res *ConfigSectionResponse, err error) {
//	err = s.requester("PUT", fmt.Sprintf("/_config/%s/%s", se, k), nil, res)
// TODO
//	return
//}
//
//func (s *server) DeleteKey(se, k string) (res *ConfigSectionResponse, err error) {
//	err = s.requester("DELETE", fmt.Sprintf("/_config/%s/%s", se, k), nil, res)
// TODO
//	return
//}
